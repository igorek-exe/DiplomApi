...
SECRET_KEY = 'django-insecure-$9jmugzbmh-i%a12@wb!f&346_4(#-d)5#y3+3zaox(ty(my3m'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # Классическая аутентификация по токенам
    ],
